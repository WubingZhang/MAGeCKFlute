...
**Hints**: you can also use a data from other analysis, just make sure the three columns (id, Score, and FDR) are available in the data.
...
#### Incorporate Depmap data into analysis
If your data only include one comparison, you can take Depmap screens as the second control for further analysis.
```{r, eval=FALSE}
